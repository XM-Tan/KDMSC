...
def get_opt():
    ...
    parser.add_argument('--dataset', default='zsmars', help='zsmars,FLO, CUB')
    parser.add_argument('--root', default='/work/tanxm/', help='path to project')      # 
    parser.add_argument('--image_root', default='/work/tanxm/data/', type=str, metavar='PATH',
                        help='path to image root')
    parser.add_argument('--matdataset', default=True, help='Data in matlab format')
    parser.add_argument('--image_embedding', default='cotlay')
    parser.add_argument('--class_embedding', default='w2v', help='bert, w2v')
    ...
    parser.add_argument('--batch_size', type=int, default=6, help='input batch size——(zsmars-7)')
    ...
    # --------------------------------------------------------
    parser.add_argument('--dis', type=float, default=0.001)   
    # --------------------------------------------------------------------------
    ...
    parser.add_argument('--seen_unseen_ratio', type=int, default=64)  

    parser.add_argument('--modaltype', type=str, default='student', help='modal type: student, teacher, distillation')
